        ...
        <div class="col-wp">
            ...
            <div class="col-fanc-right" id="wpl_flex_specific_options">
                ...
                <div class="fanc-row">
                    ...
                    <input type="text" name="<?php echo $__prefix; ?>opt_minimum_date" id="<?php echo $__prefix; ?>opt_minimum_date" value="<?php echo ($options['minimum_date'] ? $options['minimum_date'] : '1970-01-01'); ?>" />
                </div>
                <div class="fanc-row">
                    <label for="<?php echo $__prefix; ?>opt_maximum_date"><?php echo __('Max date', WPL_TEXTDOMAIN); ?></label>
                    <input type="text" name="<?php echo $__prefix; ?>opt_maximum_date" id="<?php echo $__prefix; ?>opt_maximum_date" value="<?php echo ($options['maximum_date'] ? $options['maximum_date'] : 'now'); ?>" />
                </div>
            </div>
        </div>
    </div>
