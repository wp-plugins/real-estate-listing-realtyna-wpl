...
if ($type == 'property_types' and !$done_this) {
    ...
    <div class="search-field-wp search-field-property-type <?php echo $value['enable']; ?>" 
        ...
        <div class="field-body">
            ...
            <div class="erow wpl_extoptions_span <?php echo $value['type']; ?>" id="wpl_extoptions_span_<?php echo $field->id; ?>_1">
