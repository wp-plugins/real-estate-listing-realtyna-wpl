...
<div class="fanc-row">
    ...
    <div class="wpl_flex_specificable_cnt <?php if(!isset($values->listing_specific) or (isset($values->listing_specific) and trim($values->listing_specific) == '')) echo 'wpl_hidden'; ?>" id="<?php echo $__prefix; ?>specificable1">
    ...
    <div class="wpl_flex_specificable_cnt <?php if(!isset($values->listing_specific) or (isset($values->property_type_specific) and trim($values->property_type_specific) == '')) echo 'wpl_hidden'; ?>" id="<?php echo $__prefix; ?>specificable2">
