...
if ($type == 'textsearch' and !$done_this) {
    ...
    <div class="search-field-wp search-field-textsearch <?php echo $value['enable']; ?>" 
        ...
        <div class="field-body">
            <div class="erow">
                <select name="<?php echo $this->get_field_name('data'); ?>[<?php echo $field->id; ?>][type]">
                    <option value="textbox" <?php if ($value['type'] == 'textbox') echo 'selected="selected"'; ?>><?php echo __('Textbox', WPL_TEXTDOMAIN); ?></option>
                    <option value="textarea" <?php if ($value['type'] == 'textarea') echo 'selected="selected"'; ?>><?php echo __('Textarea', WPL_TEXTDOMAIN); ?></option>
                </select>
            </div>
        </div>
    </div>
