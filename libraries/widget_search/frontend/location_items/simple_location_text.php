...
if($show == 'simple_location_text' and !$done_this)
{
	...
	$html .= '<input class="wpl_search_widget_'.$field['id'].'_location_text" value="'.$current_values['locationtextsearch'].'" name="sf'.$widget_id.'_locationtextsearch" id="sf'.$widget_id.'_locationtextsearch" placeholder="'.__('Zip-code, City, County', WPL_TEXTDOMAIN).'" type="text" />';
	$html .= '</div>';
