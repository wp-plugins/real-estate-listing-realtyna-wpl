...
?>
<div class="fanc-accordion">
    <h4 class="fanc-accordion-title" id="wpl_accordion1"><?php echo __('Basic Options', WPL_TEXTDOMAIN); ?></h4>
    <div class="wpl-accordions-cnt" id="wpl_accordion1_cnt">
        ...
        <div class="fanc-row">
            ...
            <select class="text_box" name="option[googlemap_view]" type="text" id="wpl_o_googlemap_view">
                ...
                <option value="HYBRID" <?php if(isset($this->options->googlemap_view) && $this->options->googlemap_view == 'HYBRID') echo 'selected="selected"'; ?>><?php echo __('Hybrid', WPL_TEXTDOMAIN); ?></option>
                <option value="TERRAIN" <?php if(isset($this->options->googlemap_view) && $this->options->googlemap_view == 'TERRAIN') echo 'selected="selected"'; ?>><?php echo __('Terrain', WPL_TEXTDOMAIN); ?></option>
            </select>
        </div>
        <div class="fanc-row">
...
<div class="fanc-accordion">
    <h4 class="fanc-accordion-title" id="wpl_accordion2"><?php echo __('Google Place', WPL_TEXTDOMAIN); ?></h4>
    <div class="wpl-accordions-cnt" id="wpl_accordion2_cnt">
        <div class="fanc-row">
...
<div class="fanc-accordion">
    <h4 class="fanc-accordion-title" id="wpl_accordion3"><?php echo __('Demographic', WPL_TEXTDOMAIN); ?></h4>
    <div class="wpl-accordions-cnt" id="wpl_accordion3_cnt">
        <div class="fanc-row">
            ...
            <select class="text_box" name="option[demographic]" id="wpl_o_demographic">
                <option value="0" <?php if(isset($this->options->demographic) && $this->options->demographic == 0) echo 'selected="selected"'; ?>><?php echo __('Disabled', WPL_TEXTDOMAIN); ?></option>
                <option value="1" <?php if(isset($this->options->demographic) && $this->options->demographic == 1) echo 'selected="selected"'; ?>><?php echo __('Enabled', WPL_TEXTDOMAIN); ?></option>
            </select>
        </div>
        <?php
            /** Demographic Object **/
