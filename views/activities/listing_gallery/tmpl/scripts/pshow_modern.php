...
wplj(function()
{
    ...
    wplj('#wpl_gallery_container<?php echo $this->property_id; ?>').lightSlider({
        auto: true,
        mode: 'fade',
        item: 1,
        loop: true,
        ...
        {
            if(wplj('#wpl_gallery_container<?php echo $this->property_id; ?>').find('.gallery_no_image').length == 0) {
                el.lightGallery(
                    {
