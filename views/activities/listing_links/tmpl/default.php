...
<div class="wpl_listing_links_container" id="wpl_listing_links_container<?php echo $property_id; ?>">
    ...
    <?php if($show_favorite): ?>
        ...
        <a href="#" class="icon-Send" <?php echo $find_favorite_item ? 'style="display: none;"' : ''  ?> id="wpl_favorite_add_<?php echo $property_id; ?>" onclick="return wpl_favorite_control(<?php echo $property_id; ?>, 1);"><?php echo __('Add to list', WPL_TEXTDOMAIN); ?></a>
