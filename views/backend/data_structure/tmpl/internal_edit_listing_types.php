...
<div class="fanc-content size-width-1">
    <h2><?php echo (trim($this->listing_type_data->name) != '' ? $this->listing_type_data->name : __('Add new listing type', WPL_TEXTDOMAIN)); ?></h2>
    <div class="fanc-body">
        <div class="fanc-row">
            <label for="wpl_title<?php echo $this->listing_type_id; ?>"><?php echo __('Name', WPL_TEXTDOMAIN); ?></label>
            <input class="text_box" type="text" id="wpl_name<?php echo $this->listing_type_id; ?>" value="<?php echo $this->listing_type_data->name; ?>" onchange="wpl_ajax_save_listing_type('name', this, '<?php echo $this->listing_type_id; ?>');" autocomplete="off" />
        ...
        <div class="fanc-row">
            ...
            <select class="text_box" id="wpl_parent<?php echo $this->listing_type_id; ?>" onchange="wpl_ajax_save_listing_type('parent', this, '<?php echo $this->listing_type_id; ?>');" autocomplete="off">
				...
				<option <?php if ($listing_types_category["id"] == $this->listing_type_data->parent): ?> selected="selected" <?php endif; ?> value="<?php echo $listing_types_category["id"] ?>"><?php echo $listing_types_category["name"] ?></option>
                <?php endforeach; ?>
            </select>
        ...
        <div class="fanc-row">
            ...
            <select class="text_box" id="wpl_gicon<?php echo $this->listing_type_id; ?>" onchange="wpl_ajax_save_listing_type('gicon', this, '<?php echo $this->listing_type_id; ?>');" autocomplete="off">
				...
				<option <?php if ($listing_gicon == $this->listing_type_data->gicon): ?> selected="selected" <?php endif; ?> value="<?php echo $listing_gicon ?>"><?php echo $listing_gicon ?></option>
                <?php endforeach; ?>
            </select>
