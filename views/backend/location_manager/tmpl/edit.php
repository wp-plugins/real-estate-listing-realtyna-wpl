    ...
    <div class="fanc-body">
        ...
        <div class="fanc-row fanc-button-row">
            <?php if ($this->location_id): ?>
                ...
                <input class="wpl-button button-1" type="submit" id="wpl_submit" value="<?php echo __('Save', WPL_TEXTDOMAIN); ?>" onclick="wpl_ajax_modify_location('wpl_location_name', '<?php echo $this->level; ?>', '', '<?php echo $this->location_id; ?>');" />
            <?php else: ?>
                <input class="wpl-button button-1" type="submit" id="wpl_submit" value="<?php echo __('Save', WPL_TEXTDOMAIN); ?>" onclick="wpl_ajax_modify_location('wpl_location_name', '<?php echo $this->level; ?>', '<?php echo $this->parent; ?>');" />
            <?php endif; ?>
