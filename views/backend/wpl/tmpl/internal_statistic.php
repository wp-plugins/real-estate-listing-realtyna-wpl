...
<div class="side-7 side-statistic1">
    <div class="panel-wp">
        ...
        <div class="panel-body">
        	<?php
				$properties = wpl_db::select("SELECT COUNT(*) as count, `listing` FROM `#__wpl_properties` WHERE `finalized`='1' AND `confirmed`='1' AND `expired`='1' AND `deleted`='0' AND `listing`!='0' GROUP BY `listing`", 'loadAssocList');
...
<div class="side-7 side-statistic2">
    <div class="panel-wp">
        ...
        <div class="panel-body">
        	<?php
				$properties = wpl_db::select("SELECT COUNT(*) as count, `property_type` FROM `#__wpl_properties` WHERE `finalized`='1' AND `expired`='1' AND `confirmed`='1' AND `deleted`='0' AND `property_type`!='0' GROUP BY `property_type`", 'loadAssocList');
