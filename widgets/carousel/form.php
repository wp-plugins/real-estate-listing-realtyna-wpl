...
<div class="wpl_carousel_widget_backend_form wpl-carousel-widget-<?php echo $this->widget_id; ?>" id="<?php echo $this->get_field_id('wpl_carousel_widget_container'); ?>">
    ...
    <div class="wpl-carousel-opt" data-wpl-carousel-type="default modern list" data-wpl-pl-init="default:310|modern:1920}list:90">
    ...
    <div class="wpl-carousel-opt" data-wpl-carousel-type="general" data-wpl-pl-init="default:220|modern:558|list:82">
    ...
    <div class="wpl-carousel-opt" data-wpl-carousel-type="modern" data-wpl-pl-init="modern:150">
    ...
    <div class="wpl-carousel-opt" data-wpl-carousel-type="">
    ...
    <div class="wpl-carousel-opt" data-wpl-carousel-type="default modern">
    ...
    <div class="wpl-carousel-opt" data-wpl-carousel-type="default">
    ...
    <div class="wpl-carousel-opt" data-wpl-carousel-type="multi_images">
